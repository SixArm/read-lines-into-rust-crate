...
impl ReadLinesIntoStringsWithTrimOnSelf for File {
    ...
    /// let strings: Vec<String> = file.read_lines_into_strings_with_trim().unwrap();
    /// ```
    /// 
    ...
    fn read_lines_into_strings_with_trim(self) -> ::std::io::Result<Vec<String>> {
        ...
        buf_reader.read_lines_into_strings_with_trim()
    }
...
mod tests {
    ...
    fn with_lf() {
        ...
        assert_eq!(
            file.read_lines_into_strings_with_trim().unwrap(),
